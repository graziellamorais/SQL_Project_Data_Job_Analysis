...
df_jobs = pd.read_csv('/Users/graziellamorais/Desktop/Data projects/SQL_Project_Data_Job_Analysis/csv_files/1_top_paying_jobs.csv')
df_jobs = df_jobs.sort_values(by='salary_year_avg', ascending=False)
fig, ax1 = plt.subplots(figsize=(12, 8))
bars1 = ax1.barh(df_jobs['job_title'], df_jobs['salary_year_avg'], color='skyblue', height=0.6)
for bar in bars1:
    ax1.text(bar.get_width(), bar.get_y() + bar.get_height()/2, 
            f'${bar.get_width():,.0f}', va='center', ha='left', fontsize=10, color='black',
            bbox=dict(boxstyle="round,pad=0.3", fc='white', ec='none', alpha=0.7))
ax1.set_title('Top 10 Highest-Paying Data Analyst Jobs', fontsize=18, fontweight='bold', pad=20)
...
df_skills_jobs = pd.read_csv('/Users/graziellamorais/Desktop/Data projects/SQL_Project_Data_Job_Analysis/csv_files/2_top_paying_job_skills.csv')
...
df_demanded = pd.read_csv('/Users/graziellamorais/Desktop/Data projects/SQL_Project_Data_Job_Analysis/csv_files/3_top_demanded_skills.csv')
...
df_paying_skills = pd.read_csv('/Users/graziellamorais/Desktop/Data projects/SQL_Project_Data_Job_Analysis/csv_files/4_top_paying_skills.csv')
...
df_optimal = pd.read_csv('/Users/graziellamorais/Desktop/Data projects/SQL_Project_Data_Job_Analysis/csv_files/5_optimal_skills.csv')
